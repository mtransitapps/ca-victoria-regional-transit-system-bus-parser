...
public class VictoriaRegionalTransitSystemBusAgencyTools extends DefaultAgencyTools {
	...
	public boolean mergeHeadsign(MTrip mTrip, MTrip mTripToMerge) {
		...
		if (mTrip.getRouteId() == 2L) {
			if (Arrays.asList( //
					DOWNTOWN, // same
					"James Bay - Fisherman's Wharf", // same
					"South Oak Bay - Oak Bay Vlg", //
					"Willows - Oak Bay Vlg", //
					OAK_BAY // ++
			...
			if (Arrays.asList( //
				...
				return true;
					...
					BEAR_MOUTAIN, //
					BEAR_MOUTAIN + " - " + "Lagoon" + SLASH + "Royal Bay", //
					LANGFORD_EXCH, //
					LANGFORD_EXCH + _ONLY, //
					WESTERN_SPEEDWAY //
					).containsAll(headsignsValues)) {
